...
moduleForAcceptance('[AGAT] Acceptance | i i s i b laboratornaya rabota пр комп реш l');

test('testing i-i-s-i-b-laboratornaya-rabota-пр-комп-реш-l', function(assert) {
