...
moduleForAcceptance('[AGAT] Acceptance | i i s i b laboratornaya rabota опр потр тз l');

test('testing i-i-s-i-b-laboratornaya-rabota-опр-потр-тз-l', function(assert) {
