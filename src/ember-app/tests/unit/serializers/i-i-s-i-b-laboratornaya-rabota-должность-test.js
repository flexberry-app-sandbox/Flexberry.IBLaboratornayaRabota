...
moduleForModel('i-i-s-i-b-laboratornaya-rabota-должность', 'Unit | Serializer | i-i-s-i-b-laboratornaya-rabota-должность', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-i-b-laboratornaya-rabota-должность',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
