...
moduleForModel('i-i-s-i-b-laboratornaya-rabota-спр-сотр', 'Unit | Serializer | i-i-s-i-b-laboratornaya-rabota-спр-сотр', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-i-b-laboratornaya-rabota-спр-сотр',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
