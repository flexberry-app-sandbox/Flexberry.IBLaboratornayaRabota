...
moduleForModel('i-i-s-i-b-laboratornaya-rabota-опр-потр-тз', 'Unit | Serializer | i-i-s-i-b-laboratornaya-rabota-опр-потр-тз', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-i-b-laboratornaya-rabota-опр-потр-тз',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
